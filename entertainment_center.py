...
def run():
        """ Generates a and opens a page containing my favorite movies """
...
def get_movies_list():
    return[media.Movie("Toy Story",
                        ...
                        "http://www.animated247.com/wp-content/uploads/2014/05/Toy-Story.jpg",
           ...
           media.Movie("Goodfellas",
                          ...
                          "https://upload.wikimedia.org/wikipedia/pt/7/7c/GoodfellasPoster.jpg",
           ...
           media.Movie("Pirates of Silicon Valley",
                       "it explores the impact of the rivalry between Jobs (Apple Computer) and Gates (Microsoft) on the development of the personal computer.",
           ...
           media.Movie("The Patriot",
                   "The film takes place during the events of the Southern theater of the American Revolutionary War ",
